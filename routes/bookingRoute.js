...
const { locationBookController, bookingReq, getBookingDetail, updateBookingStatus, deleteBookingReq, updateBooking, getAllBookings } = require("../controllers/booking");
